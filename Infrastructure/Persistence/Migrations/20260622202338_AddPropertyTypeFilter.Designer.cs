...
namespace IWEHZ.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260622202338_AddPropertyTypeFilter")]
    partial class AddPropertyTypeFilter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IWEHZ.Domain.Models.User", b =>
                {
                    ...
                    b.Property<string>("PropertyTypeFilter")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("property_type_filter");
